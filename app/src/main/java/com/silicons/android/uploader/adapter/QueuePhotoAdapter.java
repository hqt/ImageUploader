 ...
 */
public class QueuePhotoAdapter extends RecyclerView.Adapter<QueuePhotoAdapter.QueuedPhotoHolder> {
    ...
    private IQueuePhotoItemListener mListener;

    public QueuePhotoAdapter(IQueuePhotoItemListener listener,
    ...
    public static class QueuedPhotoHolder extends RecyclerView.ViewHolder {
        ...
        QueuedPhotoHolder(View itemView, IQueuePhotoItemListener listener) {
            super(itemView);
    ...
    public static interface IQueuePhotoItemListener {
